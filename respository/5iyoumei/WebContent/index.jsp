...
<div id="user-nav" class="navbar navbar-inverse">
  <ul class="nav">
    <li  class="dropdown" id="profile-messages" ><a title="" href="#" data-toggle="dropdown" data-target="#profile-messages" class="dropdown-toggle"><i class="icon icon-user"></i>  <span class="text">Welcome <s:property value="#request.userName"/></span><b class="caret"></b></a>
    ...
    <li class="dropdown" id="menu-messages"><a href="#" data-toggle="dropdown" data-target="#menu-messages" class="dropdown-toggle"><i class="icon icon-envelope"></i> <span class="text">Messages</span> <span class="label label-important">10000</span> <b class="caret"></b></a>
      <ul class="dropdown-menu">
...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    <li class="active"><a href="index.html"><i class="icon icon-home"></i> <span>首 页</span></a> </li>
    <li> <a href="charts.html"><i class="icon icon-user"></i> <span>个人信息</span></a> </li>
    <li> <a href="widgets.html"><i class="icon icon-inbox"></i> <span>会员注册</span></a> </li>
    <li><a href="tables.html"><i class="icon icon-th"></i> <span>财务提成</span></a></li>
    <li><a href="grid.html"><i class="icon icon-fullscreen"></i> <span>汇款登记</span></a></li>
    ...
    <li><a href="buttons.html"><i class="icon icon-key""></i> <span>登 出</span></a></li>
